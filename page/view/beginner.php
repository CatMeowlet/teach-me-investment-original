...
$query = "SELECT * FROM lessons_b WHERE mode = 'BEGINNER' ";
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				<table class="table" >
					<thead>
						<tr>
							<th class="text-left" colspan="3" >BEGINNER</th>
						</tr>
					</thead>
					<tbody>
						<?php
					...
					<tfoot>
						<tr>
							<th class="text-center" colspan="3"><a href='quiz_b.php' class='btn btn-primary btn-lg active' role='button' style='font-size: 15px' aria-pressed='true' >TAKE A QUIZ</a></th>
						</tr>
					</tfoot>
				</table>
			</div>
